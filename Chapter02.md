...
### 使用するコンピュータの仮想化支援技術の有効化 {.unlisted}
...
### ホストキーが押せない場合のホストOSの操作への復帰 {.unlisted}
