...
### 使用するコンピュータの仮想化支援技術の有効化 {.unlisted .unnumbered}
...
### VirtualBoxのダウンロード {.unlisted .unnumbered}
...
### VirtualBoxのインストーラの実行 {.unlisted .unnumbered}
VirtualBoxのインストーラをダウンロードが完了したら、インストーラを実行してインストールします。

![VirtualBoxのインストーラ画面](image/Ch02/VirtualBoxInstaller.png){width=70%}
...
### VirtualBoxマネージャー {.unlisted .unnumbered}
...
### 仮想マシンの名前とOSの設定 {.unlisted .unnumbered}
...
### 仮想マシンのハードウェアの設定 {.unlisted .unnumbered}
...
### 仮想ハードディスクの設定 {.unlisted .unnumbered}
...
### 仮想ネットワークの設定を確認 {.unlisted .unnumbered}
