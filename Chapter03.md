...
### URLが利用できない場合 {.unlisted .unnumbered}
...
### ISOイメージの種類 {.unlisted .unnumbered}
...
### ISOイメージファイルのマウント {.unlisted .unnumbered}
...
### インストーラ起動オプションの選択 {.unlisted .unnumbered}
...
### インストール先の設定 {.unlisted .unnumbered}
...
### ソフトウェアの追加インストール {.unlisted .unnumbered}
