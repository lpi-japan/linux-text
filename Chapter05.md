...
### lsコマンドによるファイルやディレクトリの参照 {.unlisted}
...
### カレントディレクトリの表示(pwdコマンド) {.unlisted}
...
### rm -rコマンドによるディレクトリとファイルの一括削除 {.unlisted}
